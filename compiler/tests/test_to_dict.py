...
def test_dense_to_dict():
    ...
    assert structure[0]["dependencies"] == []
...
def test_batchnorm_to_dict():
    ...
    assert structure[0]["dependencies"] == ["conv1"]
...
def test_relu_to_dict():
    ...
    assert structure[0]["dependencies"] == ["bn1"]
...
def test_dropout_to_dict():
    ...
    assert structure[0]["dependencies"] == ["r"]
...
def test_full_network_to_dict():
    ...
    assert structure[1]["dependencies"] == ["conv1"]
    assert structure[2]["name"] == "relu1"
    assert structure[2]["dependencies"] == ["bn1"]
    assert structure[3]["name"] == "pool1"
    assert structure[4]["name"] == "fc1"
    assert structure[4]["dependencies"] == ["pool1"]
